(function( $, WebPro, window, document, undefined ) {
	...
	WebPro.widget( "Widget.ColorPicker", WebPro.Widget, {
		_widgetName: "colorpicker",
		
		defaultOptions: {
			inputClassName: "wp-colorpicker-input",
			graphClassName: "wp-colorpicker-graph",
			hueClassName: "wp-colorpicker-hue",
			offsetX: 0,
			offsetY: 20
		},
		...
		_attachBehavior: function() {
			...
			this.graph = new WebPro.Widget.Slider( "#colorpicker .colorpicker-graph", {
				trackClassName: "graph",
				thumbClassName: "thumb",
				ignoreY: false
			});
			
			$( this.graph ).on( "wp-slider-update", function( evt, data ) {
			...
			this.hue = new WebPro.Widget.Slider( "#colorpicker .colorpicker-hue", {
				trackClassName: "hue",
				thumbClassName: "thumb",
				ignoreY: false,
				ignoreX: true
			...
			$( this.hue ).on( "wp-slider-update", function( evt, data ) {
